...
class TestExtractEnts:
    ...
    @patch("nercheck.spacy.load")
    def test_unsupported_language_skip_source_mode(self, mock_load, clear_cache, monkeypatch_env, mock_spacy_model):
    ...
    @patch("nercheck.spacy.load")
    def test_unsupported_language_strict_mode(self, mock_load, clear_cache, monkeypatch_env, mock_spacy_model):
...
class TestPreloadModels:
    ...
    @patch("nercheck.ModelCache.get_or_load")
