...
from worker.hallucination import (
    base_hallucination,
...
def clear_ner_cache():
    ...
    from worker.nercheck import ModelCache
...
class TestMultiLanguageHallucination:
    ...
    @patch("worker.language_id.detect_language")
    def test_french_to_english_no_hallucination(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model
    ):
    ...
    @patch("worker.nercheck.spacy.load")
    @patch("worker.language_id.detect_language")
    def test_german_to_english_no_hallucination(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model
    ):
    ...
    @patch("worker.nercheck.spacy.load")
    @patch("worker.language_id.detect_language")
    def test_spanish_to_english_no_hallucination(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model
    ):
    ...
    @patch("worker.nercheck.spacy.load")
    @patch("worker.language_id.detect_language")
    def test_repetition_based_hallucination(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model
    ):
    ...
    @patch("worker.nercheck.spacy.load")
    @patch("worker.language_id.detect_language")
    def test_length_ratio_hallucination(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model
    ):
    ...
    @patch("worker.nercheck.spacy.load")
    @patch("worker.language_id.detect_language")
    def test_number_consistency_pass(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model
    ):
    ...
    @patch("worker.nercheck.spacy.load")
    @patch("worker.language_id.detect_language")
    def test_number_consistency_fail(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model
    ):
    ...
    @patch("worker.nercheck.spacy.load")
    @patch("worker.language_id.detect_language")
    def test_entity_consistency_pass(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model
    ):
    ...
    @patch("worker.language_id.detect_language")
    def test_entity_consistency_fail_hallucinated_entity(
        self, mock_detect, mock_extract, clear_ner_cache
    ):
...
class TestFallbackBehavior:
    ...
    @patch("worker.nercheck.spacy.load")
    @patch("worker.language_id.detect_language")
    def test_unsupported_language_multilingual_mode(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model, monkeypatch
    ):
    ...
    @patch("worker.nercheck.spacy.load")
    @patch("worker.language_id.detect_language")
    def test_hallucination_detection_with_fallback(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model, monkeypatch
    ):
    ...
    @patch("worker.nercheck.spacy.load")
    @patch("worker.language_id.detect_language")
    def test_unsupported_language_strict_mode_fails(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model, monkeypatch
    ):
...
class TestRealWorldScenarios:
    ...
    @patch("worker.nercheck.spacy.load")
    @patch("worker.language_id.detect_language")
    def test_technical_translation_with_entities(
        self, mock_detect, mock_load, clear_ner_cache, mock_spacy_model
    ):
    ...
    @patch("worker.language_id.detect_language")
    def test_translation_with_numbers_and_dates(self, mock_detect):
    ...
    @patch("worker.nercheck.extract_ents")
    @patch("worker.language_id.detect_language")
    def test_partial_translation_entity_loss(
        self, mock_detect, mock_extract, clear_ner_cache
    ):
